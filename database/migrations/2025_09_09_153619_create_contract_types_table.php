...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('contract_types', function (Blueprint $table) { //tipo contratos
            ...
            // $table->enum('visibility', ['1', '0'])->default('1')->comment('{visibilidad} estado visible del tipo de contrato ante el uso de las compañias (visible/invisible)');
            $table->json('company_view')->nullable()->comment('{visibilidad_empresa} array de empresas a las cuales el tipo de contrato no es visible');
            $table->timestamps();
        });
    }
