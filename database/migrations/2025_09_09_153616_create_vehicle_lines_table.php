...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('vehicle_lines', function (Blueprint $table) { //tabla lineas de vehículos
            ...
            // $table->enum('visibility', ['1', '0'])->default('1')->comment('{visibilidad} estado visible de la linea del vehiculo ante el uso de las compañias (visible/invisible)');
            $table->json('company_view')->nullable()->comment('{visibilidad_empresa} array de empresas a las cuales la linea del vehiculo no es visible');
            $table->timestamps();
