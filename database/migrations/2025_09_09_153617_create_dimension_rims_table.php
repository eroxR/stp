...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('dimension_rims', function (Blueprint $table) { //tabla de las dimensiones de las llantas
            ...
            // $table->enum('visibility', ['1', '0'])->default('1')->comment('{visibilidad} estado visible del tipo de llanta ante el uso de las compañias (visible/invisible)');
            $table->json('company_view')->nullable()->comment('{visibilidad_empresa} array de empresas a las cuales la dimension de llanta no es visible');
            $table->timestamps();
        });
    }
