...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('provinces', function (Blueprint $table) { //departamentos o provincias
            ...
            // $table->enum('visibility', ['1', '0'])->default('1')->comment('{visibilidad} estado visible de la provincia ante el uso de las compañias (visible/invisible)');
            $table->json('company_view')->nullable()->comment('{visibilidad_empresa} array de empresas a las cuales el departamento no es visible');
            $table->timestamps();
